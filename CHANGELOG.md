...
- Recompiled plugin with Go version `1.23.1`. ([#30](https://github.com/turbot/steampipe-plugin-fly/pull/30))
- Recompiled plugin with [steampipe-plugin-sdk v5.11.5](https://github.com/turbot/steampipe-plugin-sdk/blob/v5.11.5/CHANGELOG.md#v5115-2025-03-31) that addresses critical and high vulnerabilities in dependent packages. ([#30](https://github.com/turbot/steampipe-plugin-fly/pull/30))
...
- Recompiled plugin with Go version `1.22`. ([#28](https://github.com/turbot/steampipe-plugin-fly/pull/28))
- Recompiled plugin with [steampipe-plugin-sdk v5.10.4](https://github.com/turbot/steampipe-plugin-sdk/blob/develop/CHANGELOG.md#v5104-2024-08-29) that fixes logging in the plugin export tool. ([#28](https://github.com/turbot/steampipe-plugin-fly/pull/28))
